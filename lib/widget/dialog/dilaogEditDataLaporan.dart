...
class Dilaogeditdatalaporan extends StatefulWidget {
  const Dilaogeditdatalaporan({super.key});

  @override
  State<Dilaogeditdatalaporan> createState() => _DilaogeditdatalaporanState();
}

class _DilaogeditdatalaporanState extends State<Dilaogeditdatalaporan> {
  @override
